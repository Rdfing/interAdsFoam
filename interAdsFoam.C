...
Description
    Multi-phase CFD solver for chemical transport and adsorption with 
    dynamic mass transfer zone induced by varying fluid interface.

Author
    Haochen Li, University of Florida
    Email: haochenli@ufl.edu
...
int main(int argc, char *argv[])
{
    ...
    #include "setODE.H" //set ODE equations
